...
def _partition_one(
    ...
    try:
        ...
        return {"doc_id": doc_id, "elements": [{"type": "Error", "text": "", "meta": {"filename": doc_id, "error": str(e)}}]}
    ...
    for el in elements:
        ...
        out.append({"type": getattr(el, "category", "Unknown"), "text": str(el), "meta": meta})
...
def partition_dir(
    ...
    *,
    ...
    with ThreadPoolExecutor(max_workers=max_concurrency) as ex:
        futs = {
            ex.submit(_partition_one, p, strategy=strategy, ocr_languages=ocr_languages,
                      skip_elements=skip_elements, include_metadata=include_metadata): p
            for p in paths
        }
